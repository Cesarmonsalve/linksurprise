// STYLE: AURORA FLOW - Northern Lights
...
export function renderAuroraFlow(d: TemplateRenderData): TemplateOutput {
  ...
  const accent = d.accentColor || '#34d399';

  const css = `
    @import url('https://fonts.googleapis.com/css2?family=Sora:wght@300;400;600;800&display=swap');
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { background: linear-gradient(180deg, #0f172a 0%, #1e293b 100%); min-height: 100vh; overflow-x: hidden; font-family: 'Sora', sans-serif; }
    ${isBasic ? `
      ...
      .orb-2 { width: 220px; height: 220px; background: #60a5fa; bottom: -60px; right: -60px; animation-delay: -5s; }

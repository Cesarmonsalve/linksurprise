// STYLE: FILM NOIR - Classic Cinema Style
...
export function renderFilmNoir(d: TemplateRenderData): TemplateOutput {
  ...
  const accent = d.accentColor || '#d4af37';

  const css = `
    @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@300;400;600;800&display=swap');
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { background: linear-gradient(180deg, #2a2a2a 0%, #1a1a1a 100%); min-height: 100vh; overflow-x: hidden; font-family: 'Playfair+Display', sans-serif; }
    ${isBasic ? `
      ...
      .orb-2 { width: 220px; height: 220px; background: #8b7355; bottom: -60px; right: -60px; animation-delay: -5s; }

// STYLE: MONO GRID - Minimalist Monochrome
...
export function renderMonoGrid(d: TemplateRenderData): TemplateOutput {
  ...
  const accent = d.accentColor || '#333333';

  const css = `
    @import url('https://fonts.googleapis.com/css2?family=Space+Mono:wght@300;400;600;800&display=swap');
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { background: linear-gradient(180deg, #ffffff 0%, #f5f5f5 100%); min-height: 100vh; overflow-x: hidden; font-family: 'Space+Mono', sans-serif; }
    ${isBasic ? `
      ...
      .orb-2 { width: 220px; height: 220px; background: #666666; bottom: -60px; right: -60px; animation-delay: -5s; }

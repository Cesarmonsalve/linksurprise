// STYLE: NEURAL PULSE - Brain Wave Visualization
...
export function renderNeuralPulse(d: TemplateRenderData): TemplateOutput {
  ...
  const accent = d.accentColor || '#00ffff';

  const css = `
    @import url('https://fonts.googleapis.com/css2?family=Rajdhani:wght@300;400;600;800&display=swap');
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { background: radial-gradient(circle at 50% 50%, #1a1a3a 0%, #0a0a1a 100%); min-height: 100vh; overflow-x: hidden; font-family: 'Rajdhani', sans-serif; }
    ${isBasic ? `
      ...
      .orb-2 { width: 220px; height: 220px; background: #ff0066; bottom: -60px; right: -60px; animation-delay: -5s; }

// STYLE: SOFT STACK - Layered Card Design
...
export function renderSoftStack(d: TemplateRenderData): TemplateOutput {
  ...
  const css = `
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { background: linear-gradient(180deg, #f1f5f9 0%, #f8fafc 100%); min-height: 100vh; overflow-x: hidden; font-family: 'Plus+Jakarta+Sans', sans-serif; }
    ${isBasic ? `
